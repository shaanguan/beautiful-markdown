var PaperShaders=(()=>{var v=Object.defineProperty;var G=Object.getOwnPropertyDescriptor;var V=Object.getOwnPropertyNames;var T=Object.prototype.hasOwnProperty;var P=(t,e)=>{for(var i in e)v(t,i,{get:e[i],enumerable:!0})},W=(t,e,i,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of V(e))!T.call(t,s)&&s!==i&&v(t,s,{get:()=>e[s],enumerable:!(r=G(e,s))||r.enumerable});return t};var y=t=>W(v({},"__esModule",{value:!0}),t);var Z={};P(Z,{ShaderFitOptions:()=>w,ShaderMount:()=>p,emptyPixel:()=>U,getShaderColorFromString:()=>S,getShaderNoiseTexture:()=>Q,paperTextureFragmentShader:()=>E});var C=`#version 300 es
...
}`;function k(){let t=navigator.userAgent.toLowerCase();return t.includes("safari")&&!t.includes("chrome")&&!t.includes("android")}function O(t){let e=(visualViewport==null?void 0:visualViewport.scale)??1,i=(visualViewport==null?void 0:visualViewport.width)??window.innerWidth,r=window.innerWidth-t.documentElement.clientWidth,s=e*i+r,o=outerWidth/s,a=Math.round(100*o);return a%5===0?a/100:a===33?1/3:a===67?2/3:a===133?4/3:o}var w={none:0,contain:1,cover:2};var R=`
