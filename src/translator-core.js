...
(function (root) {
  ...
  // Canonical language names (UI labels and prompt language tokens). All
  // English so the dropdowns read consistently regardless of the user's
  // browser locale. translator-client.js migrates legacy Chinese-script
  // values forward on load.
  const AUTO_LANGUAGE = "Auto";
  const LANGUAGE_OPTIONS = [
    AUTO_LANGUAGE, "English", "Chinese", "Spanish", "French",
